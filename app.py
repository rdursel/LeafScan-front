...
def validate_result(api_result,threshold=70):
    ...
    if first_value_accuracy > threshold:
         return "ok - the model is at "+str(first_value_accuracy) + "% confident that is a '" + first_category + "' disease"
    else:
         return "KO - Accuracy <  " + threshold
