...
def validate_result(api_result,threshold=70):
    ...
    if first_value_accuracy > threshold:
         return "Yes! I'm fairly sure, at "+ str(first_value_accuracy) + "% that I've detected a " +  f' **{first_category}** ' + f'  [link to disease description =>]{(disease_info(first_category))}' + "!"
    else:
